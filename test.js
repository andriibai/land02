...
!function (t, e) {
    ...
    var t = function (t, e) {
        ...
        var i = this;
        if (e) {
            this.element = "string" == typeof e ? document.querySelector(e) : e, this.options = t({
                ...
                hashTimeout: 600,
                callback: null
            }, n), this.assignValues(), this.debouncedAssignValuesFn = o(function () {
                return i.assignValues()
            }), window.addEventListener("resize", this.debouncedAssignValuesFn), this.debouncedHashFn = o(function () {
                var t = i.lastInViewElm ? "#" + i.lastInViewElm.id : "#";
                if (history.replaceState) history.replaceState(null, null, t); else {
                    var e = s();
    ...
    return l.prototype.assignValues = function () {
        ...
        this.scrollItems = this.menuItems.map(function (t) {
            var s = t.dataset.target ? document.querySelector(t.dataset.target) : document.getElementById(t.hash.slice(1));
        ...
        var t = this.currScrollTop + this.menuHeight, e = this.scrollItems.filter(function (e) {
            return e.offset < t
        });
        this.activateItem(e.pop())
    }, l.prototype.activateItem = function (t) {
        var e = this, s = this.options, o = s.activeClass, l = s.callback;
        if (!t)return this.scrollItems.forEach(function (t) {
            return i(t.elm.parentNode, o)
        }), this.lastInViewElm = null, void(this.options.enableLocationHash && this.debouncedHashFn());
        this.lastInViewElm !== t.target && (this.lastInViewElm = t.target, this.scrollItems.forEach(function (s) {
            i(s.elm.parentNode, o), s.target === t.target && (n(s.elm.parentNode, o), "function" == typeof l && l.call(e, s), e.options.enableLocationHash && e.debouncedHashFn())
        }))
...
!function (i) {
    ...
    (e = function () {
        ...
        if (!0 === n.options.centerMode ? !0 === n.options.infinite ? s = (o = n.currentSlide + (n.options.slidesToShow / 2 + 1)) + n.options.slidesToShow + 2 : (o = Math.max(0, n.currentSlide - (n.options.slidesToShow / 2 + 1)), s = n.options.slidesToShow / 2 + 1 + 2 + n.currentSlide) : (o = n.options.infinite ? n.options.slidesToShow + n.currentSlide : n.currentSlide, s = Math.ceil(o + n.options.slidesToShow), !0 === n.options.fade && (o > 0 && o--, s <= n.slideCount && s++)), t = n.$slider.find(".slick-slide").slice(o, s), "anticipated" === n.options.lazyLoad)for (var r = o - 1,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  a = 0; a < n.options.slidesToScroll; a++)r < 0 && (r = n.slideCount - 1), t = (t = t.add(d.eq(r))).add(d.eq(l)), r--, l++;
...
$(document).ready(function () {
    ...
    var ms = new MenuSpy(elm, {hashTimeout: 1000, threshold: 40, callback: null});
});
$(document).ready(function () {
...
$(document).ready(function () {
    var $menu = $('.main-menu'), $menulink = $('.header-menu-touch'), $blackOverlay = $('.black-overlay_menu');
...
$(document).on('click', '.popup-close', function () {
    $('.block-form').fadeOut(600);
    $('.exit-popup').fadeOut(600);
...
$(document).on('click', '.black-overlay_popup', function () {
    activekeypress();
    $('.block-form').fadeOut(600);
    $('.exit-popup').fadeOut(600);
    $('.popup-fade').fadeOut(600);
...
$(document).ready(function () {
    if ($(window).width() < 767) {
        $('.service-content.small').addClass('slider-mob');
        $('.review-content').addClass('slider-mob');
    }
    else {
        $('.service-content.smallt').removeClass('slider-mob');
        $('.review-content').removeClass('slider-mob');
    }
});
$(document).ready(function () {
    $('.slider-mob').slick({
...
/**
 * Created by BOOSTA on 11.12.2018.
 */
